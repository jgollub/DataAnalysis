...
critical_freq_number=floor((1/pi)*2*(fend-fbegin)*Q_cavity/(fbegin+fend));
    
freq_value=[800 1200 1600 2000 2400 2800 3200 critical_freq_number]
...
num_a1=20; %set to 75^2 see below
num_a2=20;
...
set(plot1(1),'DisplayName',[legend_text,num2str(freq_value(1))],...
    'Color',[0.800000011920929 0.800000011920929 1]);
set(plot1(2),'DisplayName',[legend_text,num2str(freq_value(2))],...
...
set(plot1(4),'DisplayName',[legend_text,num2str(freq_value(4))],...
    'Color',[0.200000002980232 0.200000002980232 1]);
 set(plot1(5),'DisplayName',[legend_text,num2str(freq_value(5))],'Color',[0 0 1]);
 set(plot1(6),'DisplayName',[legend_text,num2str(freq_value(6))],'Color',[0 0 0.600000023841858]);
% set(plot1(7),'DisplayName',['# Freq=',num2str(freq_value(7))],'Color',[0 0 0.800000011920929]);
set(plot1(7),'DisplayName',[ legend_text,num2str(freq_value(7)), ' (\piBQ/f0)'],'LineStyle','--','Color',[1 0 0]);
