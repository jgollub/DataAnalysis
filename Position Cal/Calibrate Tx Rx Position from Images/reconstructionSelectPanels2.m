...
function [f_mf, indices,locs, timing] = reconstructionSelectPanels2(sysConfig,...
    full_g,...
    Domain,...
...
g =reshape(full_g,sysConfig.nFrequencies,sysConfig.nPanels*sysConfig.nFeeds,sysConfig.nProbes);
...
if strcmp(parser.Results.Reconstruction,'Partitioning')
    ...
    [panelTablesPr, panelMem] =pruneBeamPattern2(panelTables, primedPanels, ChooseTx, locs_k);
    [probeTablesPr, probeMem] =pruneBeamPattern2(probeTables, primedProbes, ChooseRx, locs_k);
    % grab indices
