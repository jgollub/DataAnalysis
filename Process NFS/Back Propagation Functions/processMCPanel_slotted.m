function [reduced_region_fields, reduced_region_positions, fid_physical_position, panel_type] = processMCPanel(fields, xx, yy, zz)
...
%%%Adding horizontally
 ...
 mm=0.001;
  ...
  if MC_vertical_test>MC_horizontal_test
     ...
     fid_physical_position.lt.z= 39.514*mm;
     %fiducial right top
     fid_physical_position.rt.y= 17.998*mm;
     fid_physical_position.rt.z= 39.514*mm;
     %fiducial left bottom
     fid_physical_position.lb.y= -18*mm;
     fid_physical_position.lb.z= -39.517*mm;
     %fiducial right bottom
     fid_physical_position.rb.y= 9.998*mm;
     fid_physical_position.rb.z= -39.517*mm;
 else
     panel_type='Tx';
     
     %fiducial left top
     fid_physical_position.lt.y= -39.517*mm;
     fid_physical_position.lt.z= 18*mm;
     %fiducial right top
     fid_physical_position.rt.y= 39.517*mm;
     fid_physical_position.rt.z= 18*mm;
     %fiducial left bottom
     fid_physical_position.lb.y= -39.517*mm;
     fid_physical_position.lb.z= -17.999*mm;
     %fiducial right bottom
     fid_physical_position.rb.y= 39.517*mm;
     fid_physical_position.rb.z= -9.9967*mm;
