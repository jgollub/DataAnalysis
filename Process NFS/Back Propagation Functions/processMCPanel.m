...
%%%Adding horizontally
 ...
 if MC_vertical_test>MC_horizontal_test
     ...
     fid_physical_position.lt.z= 41.517*mm;
     %fiducial right top
     fid_physical_position.rt.y= 18*mm;
     fid_physical_position.rt.z= 41.517*mm;
     %fiducial left bottom
     fid_physical_position.lb.y= -18*mm;
     fid_physical_position.lb.z= -41.517*mm;
     %fiducial right bottom
     fid_physical_position.rb.y= 10*mm;
     fid_physical_position.rb.z= -41.517*mm;
 else
     panel_type='Tx';
     
     %fiducial left top
     fid_physical_position.lt.y= -41.517*mm;
     fid_physical_position.lt.z= 18*mm;
     %fiducial right top
     fid_physical_position.rt.y= 41.517*mm;
     fid_physical_position.rt.z= 10*mm;
     %fiducial left bottom
     fid_physical_position.lb.y= -41.517*mm;
     fid_physical_position.lb.z= -18*mm;
     %fiducial right bottom
     fid_physical_position.rb.y= 41.517*mm;
     fid_physical_position.rb.z= -18*mm;
